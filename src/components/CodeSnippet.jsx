...
const CodeSnippet = () => {
  ...
  return (
    <div className="relative rounded-md shadow-lg font-mono text-sm max-w-2xl mx-auto mb-8 overflow-hidden ring-1 ring-gray-300 dark:ring-gray-700">
  {/* Window controls */}
  ...
  {/* Code area with fixed height and stronger contrast */}
  <div className="bg-gray-100 dark:bg-gray-950 text-gray-800 dark:text-green-300 pt-10 pb-4 pl-12 pr-4 rounded-md relative min-h-[300px]">
    {/* Line numbers */}
