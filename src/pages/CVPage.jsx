  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 pt-24 pb-12 px-4 md:px-8 print:bg-white print:text-black print:pt-0">
      <div className="max-w-4xl mx-auto">
        <button
          onClick={downloadPDF}
          className="print:hidden fixed top-20 right-4 md:right-8 px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg shadow-md hover:shadow-lg transition-shadow text-sm font-medium z-50"
        >
          Download PDF
        </button>
